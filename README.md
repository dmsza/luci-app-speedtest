...
It is assumed that you already have a correctly configured OpenWrt build system. For setup instructions and build prerequisites, see the [official OpenWrt build system installation guide](https://openwrt.org/docs/guide-developer/toolchain/install-buildsystem).
